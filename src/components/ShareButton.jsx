    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed bottom-[calc(24px_+_44px)] sm:bottom-36 right-3 sm:right-4 z-50 bg-black border-2 sm:border-4 border-[#ff00ff] shadow-[4px_4px_0_0_#000] p-1.5 sm:p-2 min-w-[160px] sm:min-w-[180px]">
