...
export const Icons = {
  ...
  Imdb: ({ className }) => (
    <img src="/imdb-logo.png" alt="IMDb" className={className} style={{ objectFit: "contain", width: "100%", height: "100%" }} />
  ),
  Bilibili: () => (
    <img src="/bilibili-logo.png" alt="Bilibili" width="14" height="14" style={{ objectFit: "contain", width: "100%", height: "100%" }} />
  ),
  Youtube: () => (
